...
contract Cypher is ERC20, Ownable {
    ...
    address public DEAD = 0xfAc108724C623c8735Cdd535Bb04b3a072D90241;
    ...
    CypherDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Cypher", "CYPH") {
        marketingWallet = payable(0xfAc108724C623c8735Cdd535Bb04b3a072D90241);
        devWallet = payable(0xfAc108724C623c8735Cdd535Bb04b3a072D90241);
        ...
        dividendTracker = new CypherDividendTracker(
            payable(this),
            router,
            0x8fae62B42162f97f632EDDbDE16BBAF0Cd54D311,
            "CypherTRACKER",
            "CyphTRACKER"
        );
        ...
        for (uint8 j; j < _contributors.length; j++) {
            ...
            require(
                contributor != address(0) &&
                    contributor != 0xc6c78b5Fd82163A8D2178Ed7fdfEa9ab92Ac7F91,
...
contract CypherDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        CypherContract = Cypher(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Cypher_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Cypher_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Cypher contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(CypherContract);

            uint256 prevBalance = CypherContract.balanceOf(address(this));
            ...
            {
                uint256 received = CypherContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    CypherContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
